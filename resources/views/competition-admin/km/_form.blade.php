...
<div class="grid gap-6 lg:grid-cols-2">
    ...
    <div class="lg:col-span-2">
        ...
        <textarea id="summary" name="summary" rows="4"
            class="mt-2 w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500">{{ old('summary', $knowledgeItem->summary ?? '') }}</textarea>
    ...
    <div class="lg:col-span-2">
        ...
        <textarea id="content" name="content" rows="10"
            class="mt-2 w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500">{{ old('content', $knowledgeItem->content ?? '') }}</textarea>
    ...
    <div>
        ...
        <input id="cover_image" name="cover_image" type="file" accept="image/jpeg,image/png,image/webp"
            class="mt-2 block w-full rounded-xl border border-slate-300 bg-white p-2 text-sm">
