...
<div class="grid gap-4 lg:grid-cols-2">
    <div class="lg:col-span-2">
        ...
        <input id="title" name="title" type="text" required maxlength="255"
            ...
            class="mt-2 w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500 text-sm border py-2 h-10 px-3">
    ...
    <div class="lg:col-span-2">
        ...
        <textarea id="summary" name="summary" rows="4"
            class="mt-2 w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500 text-sm border px-3 py-2">{{ old('summary', $knowledgeItem->summary ?? '') }}</textarea>
    ...
    <div class="lg:col-span-2">
        ...
        <textarea id="content" name="content" rows="10"
            class="mt-2 w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500 text-sm border px-3 py-2">{{ old('content', $knowledgeItem->content ?? '') }}</textarea>
    ...
    <div>
        ...
        <input id="cover_image" name="cover_image" type="file" accept="image/jpeg,image/png,image/webp"
            class="mt-2 block w-full rounded-xl border border-slate-300 bg-white p-2 text-sm px-3 h-10">
    ...
    <div>
        ...
        @if ($editing && $knowledgeItem->attachment_path)
            <div class="mt-3 rounded-xl border border-slate-200 p-3 text-sm text-slate-700">
