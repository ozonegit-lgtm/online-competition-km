...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function normalizeExistingField(raw) {
        return {
            ...
            accepted_file_types: raw.type === 'file'
                ? (raw.accepted_file_types ?? @json(implode(',', config('submissions.uploads.allowed_extensions'))))
                : '',
            max_file_size: raw.type === 'file'
                ? (raw.max_file_size ?? @json(config('submissions.uploads.max_file_megabytes')))
                : null
        };
    }
