                    ...
                    <div class="grid grid-cols-2 gap-2 lg:grid-cols-1">
                        ...
                        @can($knowledgeItem->status === 'published' ? 'unpublish' : 'publish', $knowledgeItem)
                            ...
                            >
                                ...
                                <button
                                    type="submit"
                                    class="inline-flex h-8 w-full items-center justify-center gap-1.5 rounded-lg border px-3 text-xs font-semibold shadow-sm transition focus:outline-none focus:ring-2
                                        {{ $knowledgeItem->status === 'published'
                        ...
                        @can('feature', $knowledgeItem)
                            ...
                            >
                                ...
                                <button
                                    type="submit"
                                    class="inline-flex h-8 w-full items-center justify-center gap-1.5 rounded-lg border border-amber-200 bg-white px-3 text-xs font-semibold text-amber-700 shadow-sm transition hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-amber-300"
                                >
                                    <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="{{ $knowledgeItem->is_featured ? 'currentColor' : 'none' }}" stroke="currentColor" stroke-width="2" aria-hidden="true">
                                        <path d="m12 3 2.8 5.7 6.2.9-4.5 4.4 1.1 6.2L12 17.3l-5.6 2.9 1.1-6.2L3 9.6l6.2-.9L12 3Z"/>
                                    </svg>
